...
function IconPencilEdit({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
...
function IconFloppyDisk({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      data-testid="geist-icon"
      height="16"
...
function IconFoo({ className, ...props }: React.ComponentProps<'svg'>) {
  return <svg className={cn('size-4', className)} {...props}></svg>
}
